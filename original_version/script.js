...
var cardGridHTML = '<div class="card-grid"> <a class="project-card" style="--cindex: 0" href="./projects/astar.html" target="_blank"> <div class="card-info"> <h2 class="card-title">A* Pathfinder</h2> <p class="card-body">Try out an interactive A* pathfinding program!</p> </div> </a> <a class="project-card-b" style="--cindex: 1" href="https://dhdorr.itch.io/" target="_blank"> <div class="card-info"> <h2 class="card-title">Published Games</h2> <p class="card-body">Check out and play some of my game jam submissions!</p> </div> </a> <a class="project-card-c" style="--cindex: 2" href="https://github.com/dhdorr" target="_blank"> <div class="card-info"> <h2 class="card-title">Github Repos</h2> <p class="card-body">See what I\x27m working on now, and browse my repositories!</p> </div> </a> <a class="project-card-d" style="--cindex: 3" href="./projects/word-masters-project/index.html" target="_blank"> <div class="card-info"> <h2 class="card-title">More to Come</h2> <p class="card-body"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem, reiciendis. </p> </div> </a> </div>';
